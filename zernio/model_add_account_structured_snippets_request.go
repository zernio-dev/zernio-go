...
func (o *AddAccountStructuredSnippetsRequest) GetAdAccountId() string {
...
// and a boolean to check if the value has been set.
func (o *AddAccountStructuredSnippetsRequest) GetAdAccountIdOk() (*string, bool) {
	if o == nil || IsNil(o.AdAccountId) {
		return nil, false
	}
...
func (o *AddAccountStructuredSnippetsRequest) HasAdAccountId() bool {
	if o != nil && !IsNil(o.AdAccountId) {
		return true
	}
...
func (o *AddAccountStructuredSnippetsRequest) SetAdAccountId(v string) {
	o.AdAccountId = &v
}
