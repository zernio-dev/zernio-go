...
// checks if the GetWhatsAppPhoneNumber200ResponsePhoneNumber type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWhatsAppPhoneNumber200ResponsePhoneNumber{}

// GetWhatsAppPhoneNumber200ResponsePhoneNumber struct for GetWhatsAppPhoneNumber200ResponsePhoneNumber
type GetWhatsAppPhoneNumber200ResponsePhoneNumber struct {
...
func NewGetWhatsAppPhoneNumber200ResponsePhoneNumber() *GetWhatsAppPhoneNumber200ResponsePhoneNumber {
	this := GetWhatsAppPhoneNumber200ResponsePhoneNumber{}
	return &this
}
...
func (o *GetWhatsAppPhoneNumber200ResponsePhoneNumber) SetOnfidoVerificationUrlNil() {
...
func (o *GetWhatsAppPhoneNumber200ResponsePhoneNumber) SetEndUserFirstNameNil() {
...
func (o *GetWhatsAppPhoneNumber200ResponsePhoneNumber) SetEndUserLastNameNil() {
...
func (o *GetWhatsAppPhoneNumber200ResponsePhoneNumber) SetRegulatoryDeclineReasonNil() {
...
func (o GetWhatsAppPhoneNumber200ResponsePhoneNumber) MarshalJSON() ([]byte, error) {
...
func (o GetWhatsAppPhoneNumber200ResponsePhoneNumber) ToMap() (map[string]interface{}, error) {
...
type NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber struct {
	value *GetWhatsAppPhoneNumber200ResponsePhoneNumber
	isSet bool
}

func (v NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) Get() *GetWhatsAppPhoneNumber200ResponsePhoneNumber {
	return v.value
}

func (v *NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) Set(val *GetWhatsAppPhoneNumber200ResponsePhoneNumber) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWhatsAppPhoneNumber200ResponsePhoneNumber(val *GetWhatsAppPhoneNumber200ResponsePhoneNumber) *NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber {
	return &NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber{value: val, isSet: true}
}

func (v NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWhatsAppPhoneNumber200ResponsePhoneNumber) UnmarshalJSON(src []byte) error {
	v.isSet = true
