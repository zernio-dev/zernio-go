...
type AdsAPICreateAdCreativeRequest struct {
	ctx                     context.Context
	ApiService              *AdsAPIService
	createAdCreativeRequest *CreateAdCreativeRequest
}

func (r AdsAPICreateAdCreativeRequest) CreateAdCreativeRequest(createAdCreativeRequest CreateAdCreativeRequest) AdsAPICreateAdCreativeRequest {
	r.createAdCreativeRequest = &createAdCreativeRequest
	return r
}

func (r AdsAPICreateAdCreativeRequest) Execute() (*CreateAdCreative201Response, *http.Response, error) {
	return r.ApiService.CreateAdCreativeExecute(r)
}

/*
CreateAdCreative Create a standalone creative (Meta)
...
from `accountId` as the story actor. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPICreateAdCreativeRequest
*/
func (a *AdsAPIService) CreateAdCreative(ctx context.Context) AdsAPICreateAdCreativeRequest {
	return AdsAPICreateAdCreativeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) CreateAdCreativeExecute(r AdsAPICreateAdCreativeRequest) (*CreateAdCreative201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.CreateAdCreative")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPICreateCallAdRequest struct {
	ctx                 context.Context
	ApiService          *AdsAPIService
	createCallAdRequest *CreateCallAdRequest
}

func (r AdsAPICreateCallAdRequest) CreateCallAdRequest(createCallAdRequest CreateCallAdRequest) AdsAPICreateCallAdRequest {
	r.createCallAdRequest = &createCallAdRequest
	return r
}

func (r AdsAPICreateCallAdRequest) Execute() (*http.Response, error) {
...
Supports the same single-creative and multi-creative shapes as CTWA.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPICreateCallAdRequest
*/
func (a *AdsAPIService) CreateCallAd(ctx context.Context) AdsAPICreateCallAdRequest {
	return AdsAPICreateCallAdRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *AdsAPIService) CreateCallAdExecute(r AdsAPICreateCallAdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.CreateCallAd")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r AdsAPICreateCtwaAdRequest) CtwaAdRequestBody(ctwaAdRequestBody CtwaAdRequestBody) AdsAPICreateCtwaAdRequest {
...
type AdsAPICreateMessagingAdRequest struct {
	ctx                      context.Context
	ApiService               *AdsAPIService
	createMessagingAdRequest *CreateMessagingAdRequest
}

func (r AdsAPICreateMessagingAdRequest) CreateMessagingAdRequest(createMessagingAdRequest CreateMessagingAdRequest) AdsAPICreateMessagingAdRequest {
	r.createMessagingAdRequest = &createMessagingAdRequest
	return r
}

func (r AdsAPICreateMessagingAdRequest) Execute() (*http.Response, error) {
...
(deprecated, equivalent to `destination: whatsapp`).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPICreateMessagingAdRequest
*/
func (a *AdsAPIService) CreateMessagingAd(ctx context.Context) AdsAPICreateMessagingAdRequest {
	return AdsAPICreateMessagingAdRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *AdsAPIService) CreateMessagingAdExecute(r AdsAPICreateMessagingAdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.CreateMessagingAd")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r AdsAPICreateStandaloneAdRequest) Execute() (*CreateStandaloneAd200Response, *http.Response, error) {
...
func (a *AdsAPIService) CreateStandaloneAdExecute(r AdsAPICreateStandaloneAdRequest) (*CreateStandaloneAd200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
type AdsAPIDeleteAdCreativeRequest struct {
	ctx        context.Context
	ApiService *AdsAPIService
	creativeId string
	accountId  *string
...
func (r AdsAPIDeleteAdCreativeRequest) AccountId(accountId string) AdsAPIDeleteAdCreativeRequest {
	r.accountId = &accountId
	return r
}

func (r AdsAPIDeleteAdCreativeRequest) Execute() (*DeleteAdCreative200Response, *http.Response, error) {
	return r.ApiService.DeleteAdCreativeExecute(r)
}

/*
DeleteAdCreative Delete a creative (Meta)
...
by any ad — otherwise its 400 surfaces verbatim.
	...
	@return AdsAPIDeleteAdCreativeRequest
*/
func (a *AdsAPIService) DeleteAdCreative(ctx context.Context, creativeId string) AdsAPIDeleteAdCreativeRequest {
	return AdsAPIDeleteAdCreativeRequest{
		ApiService: a,
		ctx:        ctx,
...
func (a *AdsAPIService) DeleteAdCreativeExecute(r AdsAPIDeleteAdCreativeRequest) (*DeleteAdCreative200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.DeleteAdCreative")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIDuplicateAdRequest struct {
	ctx                context.Context
	ApiService         *AdsAPIService
	adId               string
...
func (r AdsAPIDuplicateAdRequest) DuplicateAdRequest(duplicateAdRequest DuplicateAdRequest) AdsAPIDuplicateAdRequest {
	r.duplicateAdRequest = &duplicateAdRequest
	return r
}

func (r AdsAPIDuplicateAdRequest) Execute() (*DuplicateAd200Response, *http.Response, error) {
	return r.ApiService.DuplicateAdExecute(r)
}

/*
DuplicateAd Duplicate an ad (Meta)
...
automatically (`syncAfter: false` to skip). Meta only.
	...
	@return AdsAPIDuplicateAdRequest
*/
func (a *AdsAPIService) DuplicateAd(ctx context.Context, adId string) AdsAPIDuplicateAdRequest {
	return AdsAPIDuplicateAdRequest{
		ApiService: a,
		ctx:        ctx,
		adId:       adId,
...
func (a *AdsAPIService) DuplicateAdExecute(r AdsAPIDuplicateAdRequest) (*DuplicateAd200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.DuplicateAd")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIGenerateAdPreviewsRequest struct {
	ctx                       context.Context
	ApiService                *AdsAPIService
	generateAdPreviewsRequest *GenerateAdPreviewsRequest
}

func (r AdsAPIGenerateAdPreviewsRequest) GenerateAdPreviewsRequest(generateAdPreviewsRequest GenerateAdPreviewsRequest) AdsAPIGenerateAdPreviewsRequest {
	r.generateAdPreviewsRequest = &generateAdPreviewsRequest
	return r
}

func (r AdsAPIGenerateAdPreviewsRequest) Execute() (*GenerateAdPreviews200Response, *http.Response, error) {
	return r.ApiService.GenerateAdPreviewsExecute(r)
}

/*
GenerateAdPreviews Render pre-create ad previews (Meta)
...
return Meta's 400 verbatim. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIGenerateAdPreviewsRequest
*/
func (a *AdsAPIService) GenerateAdPreviews(ctx context.Context) AdsAPIGenerateAdPreviewsRequest {
	return AdsAPIGenerateAdPreviewsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) GenerateAdPreviewsExecute(r AdsAPIGenerateAdPreviewsRequest) (*GenerateAdPreviews200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.GenerateAdPreviews")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIGetAdAccountFinanceRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIGetAdAccountFinanceRequest) AccountId(accountId string) AdsAPIGetAdAccountFinanceRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIGetAdAccountFinanceRequest) AdAccountId(adAccountId string) AdsAPIGetAdAccountFinanceRequest {
	r.adAccountId = &adAccountId
	return r
}

func (r AdsAPIGetAdAccountFinanceRequest) Execute() (*GetAdAccountFinance200Response, *http.Response, error) {
	return r.ApiService.GetAdAccountFinanceExecute(r)
}

/*
GetAdAccountFinance Ad account finances (Meta)
...
Meta's minor units to whole units of `currency`. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIGetAdAccountFinanceRequest
*/
func (a *AdsAPIService) GetAdAccountFinance(ctx context.Context) AdsAPIGetAdAccountFinanceRequest {
	return AdsAPIGetAdAccountFinanceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) GetAdAccountFinanceExecute(r AdsAPIGetAdAccountFinanceRequest) (*GetAdAccountFinance200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.GetAdAccountFinance")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIGetAdCreativeRequest struct {
	ctx        context.Context
	ApiService *AdsAPIService
	creativeId string
	accountId  *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIGetAdCreativeRequest) AccountId(accountId string) AdsAPIGetAdCreativeRequest {
	r.accountId = &accountId
	return r
}

// Comma-separated Graph field override (supports nested {} projections).
func (r AdsAPIGetAdCreativeRequest) Fields(fields string) AdsAPIGetAdCreativeRequest {
	r.fields = &fields
	return r
}

func (r AdsAPIGetAdCreativeRequest) Execute() (*GetAdCreative200Response, *http.Response, error) {
	return r.ApiService.GetAdCreativeExecute(r)
}

/*
GetAdCreative Creative details (Meta)
...
the default projection. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param creativeId Platform creative id
	@return AdsAPIGetAdCreativeRequest
*/
func (a *AdsAPIService) GetAdCreative(ctx context.Context, creativeId string) AdsAPIGetAdCreativeRequest {
	return AdsAPIGetAdCreativeRequest{
		ApiService: a,
		ctx:        ctx,
		creativeId: creativeId,
...
func (a *AdsAPIService) GetAdCreativeExecute(r AdsAPIGetAdCreativeRequest) (*GetAdCreative200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.GetAdCreative")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIGetAdPreviewsRequest struct {
	ctx        context.Context
	ApiService *AdsAPIService
	adId       string
	formats    *string
...
func (r AdsAPIGetAdPreviewsRequest) Formats(formats string) AdsAPIGetAdPreviewsRequest {
	r.formats = &formats
	return r
}

func (r AdsAPIGetAdPreviewsRequest) Execute() (*GetAdPreviews200Response, *http.Response, error) {
	return r.ApiService.GetAdPreviewsExecute(r)
}

/*
GetAdPreviews Render previews of an existing ad (Meta)
...
Meta only.
	...
	@return AdsAPIGetAdPreviewsRequest
*/
func (a *AdsAPIService) GetAdPreviews(ctx context.Context, adId string) AdsAPIGetAdPreviewsRequest {
	return AdsAPIGetAdPreviewsRequest{
		ApiService: a,
		ctx:        ctx,
		adId:       adId,
...
func (a *AdsAPIService) GetAdPreviewsExecute(r AdsAPIGetAdPreviewsRequest) (*GetAdPreviews200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.GetAdPreviews")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIGetAdsActivityLogRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIGetAdsActivityLogRequest) AccountId(accountId string) AdsAPIGetAdsActivityLogRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIGetAdsActivityLogRequest) AdAccountId(adAccountId string) AdsAPIGetAdsActivityLogRequest {
	r.adAccountId = &adAccountId
	return r
}

// Start of range (YYYY-MM-DD).
func (r AdsAPIGetAdsActivityLogRequest) Since(since string) AdsAPIGetAdsActivityLogRequest {
	r.since = &since
	return r
}

// End of range (YYYY-MM-DD).
func (r AdsAPIGetAdsActivityLogRequest) Until(until string) AdsAPIGetAdsActivityLogRequest {
	r.until = &until
	return r
}

// Client-side filter to one Meta object id (campaign, ad set or ad).
func (r AdsAPIGetAdsActivityLogRequest) ObjectId(objectId string) AdsAPIGetAdsActivityLogRequest {
	r.objectId = &objectId
	return r
}

// Rows per page
func (r AdsAPIGetAdsActivityLogRequest) Limit(limit int32) AdsAPIGetAdsActivityLogRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIGetAdsActivityLogRequest) After(after string) AdsAPIGetAdsActivityLogRequest {
	r.after = &after
	return r
}

func (r AdsAPIGetAdsActivityLogRequest) Execute() (*GetAdsActivityLog200Response, *http.Response, error) {
	return r.ApiService.GetAdsActivityLogExecute(r)
}

/*
GetAdsActivityLog Ad account change / audit log (Meta)
...
client-side (combine with paging to walk history for one campaign/ad set/ad). Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIGetAdsActivityLogRequest
*/
func (a *AdsAPIService) GetAdsActivityLog(ctx context.Context) AdsAPIGetAdsActivityLogRequest {
	return AdsAPIGetAdsActivityLogRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) GetAdsActivityLogExecute(r AdsAPIGetAdsActivityLogRequest) (*GetAdsActivityLog200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.GetAdsActivityLog")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListAdCreativesRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListAdCreativesRequest) AccountId(accountId string) AdsAPIListAdCreativesRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIListAdCreativesRequest) AdAccountId(adAccountId string) AdsAPIListAdCreativesRequest {
	r.adAccountId = &adAccountId
	return r
}

// Comma-separated Graph field override (supports nested {} projections).
func (r AdsAPIListAdCreativesRequest) Fields(fields string) AdsAPIListAdCreativesRequest {
	r.fields = &fields
	return r
}

// Rows per page
func (r AdsAPIListAdCreativesRequest) Limit(limit int32) AdsAPIListAdCreativesRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListAdCreativesRequest) After(after string) AdsAPIListAdCreativesRequest {
	r.after = &after
	return r
}

func (r AdsAPIListAdCreativesRequest) Execute() (*GetAdsActivityLog200Response, *http.Response, error) {
	return r.ApiService.ListAdCreativesExecute(r)
}

/*
ListAdCreatives Creative library (Meta)
...
`existingCreativeId`. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListAdCreativesRequest
*/
func (a *AdsAPIService) ListAdCreatives(ctx context.Context) AdsAPIListAdCreativesRequest {
	return AdsAPIListAdCreativesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetAdsActivityLog200Response
func (a *AdsAPIService) ListAdCreativesExecute(r AdsAPIListAdCreativesRequest) (*GetAdsActivityLog200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListAdCreatives")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListAdImagesRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListAdImagesRequest) AccountId(accountId string) AdsAPIListAdImagesRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIListAdImagesRequest) AdAccountId(adAccountId string) AdsAPIListAdImagesRequest {
	r.adAccountId = &adAccountId
	return r
}

// Comma-separated Graph field override (supports nested {} projections).
func (r AdsAPIListAdImagesRequest) Fields(fields string) AdsAPIListAdImagesRequest {
	r.fields = &fields
	return r
}

// Rows per page
func (r AdsAPIListAdImagesRequest) Limit(limit int32) AdsAPIListAdImagesRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListAdImagesRequest) After(after string) AdsAPIListAdImagesRequest {
	r.after = &after
	return r
}

func (r AdsAPIListAdImagesRequest) Execute() (*GetAdsActivityLog200Response, *http.Response, error) {
	return r.ApiService.ListAdImagesExecute(r)
}

/*
ListAdImages Ad image library (Meta)
...
`image_hash` (e.g. `imageHash` on POST /v1/ads/creatives). Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListAdImagesRequest
*/
func (a *AdsAPIService) ListAdImages(ctx context.Context) AdsAPIListAdImagesRequest {
	return AdsAPIListAdImagesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetAdsActivityLog200Response
func (a *AdsAPIService) ListAdImagesExecute(r AdsAPIListAdImagesRequest) (*GetAdsActivityLog200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListAdImages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListAdLabelsRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListAdLabelsRequest) AccountId(accountId string) AdsAPIListAdLabelsRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIListAdLabelsRequest) AdAccountId(adAccountId string) AdsAPIListAdLabelsRequest {
	r.adAccountId = &adAccountId
	return r
}

// Rows per page
func (r AdsAPIListAdLabelsRequest) Limit(limit int32) AdsAPIListAdLabelsRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListAdLabelsRequest) After(after string) AdsAPIListAdLabelsRequest {
	r.after = &after
	return r
}

func (r AdsAPIListAdLabelsRequest) Execute() (*GetAdsActivityLog200Response, *http.Response, error) {
	return r.ApiService.ListAdLabelsExecute(r)
}

/*
ListAdLabels Ad labels (Meta)
...
verbatim (id, name, created/updated time). Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListAdLabelsRequest
*/
func (a *AdsAPIService) ListAdLabels(ctx context.Context) AdsAPIListAdLabelsRequest {
	return AdsAPIListAdLabelsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetAdsActivityLog200Response
func (a *AdsAPIService) ListAdLabelsExecute(r AdsAPIListAdLabelsRequest) (*GetAdsActivityLog200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListAdLabels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListAdStudiesRequest struct {
	ctx         context.Context
	ApiService  *AdsAPIService
	accountId   *string
	adAccountId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListAdStudiesRequest) AccountId(accountId string) AdsAPIListAdStudiesRequest {
	r.accountId = &accountId
	return r
}

// Meta ad account id (act_&lt;n&gt;).
func (r AdsAPIListAdStudiesRequest) AdAccountId(adAccountId string) AdsAPIListAdStudiesRequest {
	r.adAccountId = &adAccountId
	return r
}

// Comma-separated Graph field override (supports nested {} projections).
func (r AdsAPIListAdStudiesRequest) Fields(fields string) AdsAPIListAdStudiesRequest {
	r.fields = &fields
	return r
}

// Rows per page
func (r AdsAPIListAdStudiesRequest) Limit(limit int32) AdsAPIListAdStudiesRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListAdStudiesRequest) After(after string) AdsAPIListAdStudiesRequest {
	r.after = &after
	return r
}

func (r AdsAPIListAdStudiesRequest) Execute() (*GetAdsActivityLog200Response, *http.Response, error) {
	return r.ApiService.ListAdStudiesExecute(r)
}

/*
ListAdStudies A/B tests and lift studies (Meta)
...
split percentages; `fields` is a raw-passthrough override. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListAdStudiesRequest
*/
func (a *AdsAPIService) ListAdStudies(ctx context.Context) AdsAPIListAdStudiesRequest {
	return AdsAPIListAdStudiesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return GetAdsActivityLog200Response
func (a *AdsAPIService) ListAdStudiesExecute(r AdsAPIListAdStudiesRequest) (*GetAdsActivityLog200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListAdStudies")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListHighDemandPeriodsRequest struct {
	ctx        context.Context
	ApiService *AdsAPIService
	accountId  *string
	campaignId *string
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListHighDemandPeriodsRequest) AccountId(accountId string) AdsAPIListHighDemandPeriodsRequest {
	r.accountId = &accountId
	return r
}

// Platform campaign id. Exactly one of campaignId / adSetId.
func (r AdsAPIListHighDemandPeriodsRequest) CampaignId(campaignId string) AdsAPIListHighDemandPeriodsRequest {
	r.campaignId = &campaignId
	return r
}

// Platform ad set id. Exactly one of campaignId / adSetId.
func (r AdsAPIListHighDemandPeriodsRequest) AdSetId(adSetId string) AdsAPIListHighDemandPeriodsRequest {
	r.adSetId = &adSetId
	return r
}

// Rows per page
func (r AdsAPIListHighDemandPeriodsRequest) Limit(limit int32) AdsAPIListHighDemandPeriodsRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListHighDemandPeriodsRequest) After(after string) AdsAPIListHighDemandPeriodsRequest {
	r.after = &after
	return r
}

func (r AdsAPIListHighDemandPeriodsRequest) Execute() (*QueryAdInsights200Response, *http.Response, error) {
	return r.ApiService.ListHighDemandPeriodsExecute(r)
}

/*
ListHighDemandPeriods High demand periods / budget schedules (Meta)
...
recurrence). Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListHighDemandPeriodsRequest
*/
func (a *AdsAPIService) ListHighDemandPeriods(ctx context.Context) AdsAPIListHighDemandPeriodsRequest {
	return AdsAPIListHighDemandPeriodsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) ListHighDemandPeriodsExecute(r AdsAPIListHighDemandPeriodsRequest) (*QueryAdInsights200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListHighDemandPeriods")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIListMetaBusinessesRequest struct {
	ctx        context.Context
	ApiService *AdsAPIService
	accountId  *string
	limit      *int32
...
// Zernio SocialAccount id (posting or ads variant) used to resolve the Meta token.
func (r AdsAPIListMetaBusinessesRequest) AccountId(accountId string) AdsAPIListMetaBusinessesRequest {
	r.accountId = &accountId
	return r
}

// Rows per page
func (r AdsAPIListMetaBusinessesRequest) Limit(limit int32) AdsAPIListMetaBusinessesRequest {
	r.limit = &limit
	return r
}

// Cursor from paging.after of the previous page.
func (r AdsAPIListMetaBusinessesRequest) After(after string) AdsAPIListMetaBusinessesRequest {
	r.after = &after
	return r
}

func (r AdsAPIListMetaBusinessesRequest) Execute() (*ListMetaBusinesses200Response, *http.Response, error) {
	return r.ApiService.ListMetaBusinessesExecute(r)
}

/*
ListMetaBusinesses Businesses list (Meta)
...
`GET /v1/ads/business-centers`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIListMetaBusinessesRequest
*/
func (a *AdsAPIService) ListMetaBusinesses(ctx context.Context) AdsAPIListMetaBusinessesRequest {
	return AdsAPIListMetaBusinessesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) ListMetaBusinessesExecute(r AdsAPIListMetaBusinessesRequest) (*ListMetaBusinesses200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.ListMetaBusinesses")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIUpdateAdCreativeRequest struct {
	ctx                     context.Context
	ApiService              *AdsAPIService
	creativeId              string
...
func (r AdsAPIUpdateAdCreativeRequest) UpdateAdCreativeRequest(updateAdCreativeRequest UpdateAdCreativeRequest) AdsAPIUpdateAdCreativeRequest {
	r.updateAdCreativeRequest = &updateAdCreativeRequest
	return r
}

func (r AdsAPIUpdateAdCreativeRequest) Execute() (*UpdateAdCreative200Response, *http.Response, error) {
	return r.ApiService.UpdateAdCreativeExecute(r)
}

/*
UpdateAdCreative Rename a creative (Meta)
...
(PUT /v1/ads/{adId} with `creative`). Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param creativeId Platform creative id
	@return AdsAPIUpdateAdCreativeRequest
*/
func (a *AdsAPIService) UpdateAdCreative(ctx context.Context, creativeId string) AdsAPIUpdateAdCreativeRequest {
	return AdsAPIUpdateAdCreativeRequest{
		ApiService: a,
		ctx:        ctx,
		creativeId: creativeId,
...
func (a *AdsAPIService) UpdateAdCreativeExecute(r AdsAPIUpdateAdCreativeRequest) (*UpdateAdCreative200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.UpdateAdCreative")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AdsAPIUploadAdImageRequest struct {
	ctx                  context.Context
	ApiService           *AdsAPIService
	uploadAdImageRequest *UploadAdImageRequest
}

func (r AdsAPIUploadAdImageRequest) UploadAdImageRequest(uploadAdImageRequest UploadAdImageRequest) AdsAPIUploadAdImageRequest {
	r.uploadAdImageRequest = &uploadAdImageRequest
	return r
}

func (r AdsAPIUploadAdImageRequest) Execute() (*UploadAdImage201Response, *http.Response, error) {
	return r.ApiService.UploadAdImageExecute(r)
}

/*
UploadAdImage Upload an ad image from base64 (Meta)
...
create endpoints. Max 30 MB decoded. Meta only.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdsAPIUploadAdImageRequest
*/
func (a *AdsAPIService) UploadAdImage(ctx context.Context) AdsAPIUploadAdImageRequest {
	return AdsAPIUploadAdImageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdsAPIService) UploadAdImageExecute(r AdsAPIUploadAdImageRequest) (*UploadAdImage201Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdsAPIService.UploadAdImage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
