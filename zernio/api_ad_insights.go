...
/*
CreateAdInsightsReport Submit async insights report
...
/*
GenerateKeywordHistoricalMetrics Get historical keyword metrics
...
/*
GenerateKeywordIdeas Generate keyword ideas
...
type AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest struct {
	ctx            context.Context
	ApiService     *AdInsightsAPIService
	accountId      *string
	adAccountId    *string
...
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) AccountId(accountId string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.accountId = &accountId
	return r
}

// TikTok advertiser ID
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) AdAccountId(adAccountId string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.adAccountId = &adAccountId
	return r
}

// YYYY-MM-DD, in the advertiser&#39;s time zone
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) StartDate(startDate string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.startDate = &startDate
	return r
}

// YYYY-MM-DD, on or after startDate
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) EndDate(endDate string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.endDate = &endDate
	return r
}

// Key each row by Smart+ ad or by ad group
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) Level(level string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.level = &level
	return r
}

// Comma-separated Smart+ ad ids to filter by (up to 100)
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) SmartPlusAdIds(smartPlusAdIds string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.smartPlusAdIds = &smartPlusAdIds
	return r
}

// Comma-separated ad group ids to filter by (up to 100)
func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) AdGroupIds(adGroupIds string) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.adGroupIds = &adGroupIds
	return r
}

func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) Page(page int32) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.page = &page
	return r
}

func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) PageSize(pageSize int32) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	r.pageSize = &pageSize
	return r
}

func (r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) Execute() (*GetTikTokSmartPlusMaterialReport200Response, *http.Response, error) {
	return r.ApiService.GetTikTokSmartPlusMaterialReportExecute(r)
}
...
*/
func (a *AdInsightsAPIService) GetTikTokSmartPlusMaterialReport(ctx context.Context) AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest {
	return AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdInsightsAPIService) GetTikTokSmartPlusMaterialReportExecute(r AdInsightsAPIGetTikTokSmartPlusMaterialReportRequest) (*GetTikTokSmartPlusMaterialReport200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetTikTokSmartPlusMaterialReport200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdInsightsAPIService.GetTikTokSmartPlusMaterialReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/ads/tiktok-smart-plus-materials"
	...
	if r.level != nil {
		...
		var defaultValue string = "ad"
		parameterAddToHeaderOrQuery(localVarQueryParams, "level", defaultValue, "form", "")
		r.level = &defaultValue
	}
	if r.smartPlusAdIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "smartPlusAdIds", r.smartPlusAdIds, "form", "")
	}
	if r.adGroupIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "adGroupIds", r.adGroupIds, "form", "")
	}
	if r.page != nil {
...
/*
ListLocalServicesLeadConversations List lead conversations
