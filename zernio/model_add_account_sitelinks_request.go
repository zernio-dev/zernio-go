...
func (o *AddAccountSitelinksRequest) GetAdAccountId() string {
...
// and a boolean to check if the value has been set.
func (o *AddAccountSitelinksRequest) GetAdAccountIdOk() (*string, bool) {
	if o == nil || IsNil(o.AdAccountId) {
		return nil, false
	}
...
func (o *AddAccountSitelinksRequest) HasAdAccountId() bool {
	if o != nil && !IsNil(o.AdAccountId) {
		return true
	}
...
func (o *AddAccountSitelinksRequest) SetAdAccountId(v string) {
	o.AdAccountId = &v
}
