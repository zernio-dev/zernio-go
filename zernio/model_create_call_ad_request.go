...
func NewCreateCallAdRequest(accountId string, adAccountId string, name string, budgetAmount float32, budgetType string, phoneNumber string, linkUrl string) *CreateCallAdRequest {
