...
func (o *InstagramAccountInsightsResponse) GetUnavailableMetrics() []InstagramAccountInsightsResponseUnavailableMetricsInner {
...
// and a boolean to check if the value has been set.
func (o *InstagramAccountInsightsResponse) GetUnavailableMetricsOk() ([]InstagramAccountInsightsResponseUnavailableMetricsInner, bool) {
	if o == nil || IsNil(o.UnavailableMetrics) {
		return nil, false
	}
...
func (o *InstagramAccountInsightsResponse) HasUnavailableMetrics() bool {
	if o != nil && !IsNil(o.UnavailableMetrics) {
		return true
	}
...
func (o *InstagramAccountInsightsResponse) SetUnavailableMetrics(v []InstagramAccountInsightsResponseUnavailableMetricsInner) {
