...
// checks if the GetWhatsAppNumberKycForm200ResponseFieldsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWhatsAppNumberKycForm200ResponseFieldsInner{}

// GetWhatsAppNumberKycForm200ResponseFieldsInner struct for GetWhatsAppNumberKycForm200ResponseFieldsInner
type GetWhatsAppNumberKycForm200ResponseFieldsInner struct {
...
func NewGetWhatsAppNumberKycForm200ResponseFieldsInner() *GetWhatsAppNumberKycForm200ResponseFieldsInner {
	this := GetWhatsAppNumberKycForm200ResponseFieldsInner{}
	return &this
}
...
func (o *GetWhatsAppNumberKycForm200ResponseFieldsInner) SetDescriptionNil() {
...
func (o *GetWhatsAppNumberKycForm200ResponseFieldsInner) SetExampleNil() {
	o.Example.Set(nil)
}
...
func (o *GetWhatsAppNumberKycForm200ResponseFieldsInner) SetLocalToNil() {
	o.LocalTo.Set(nil)
}
...
func (o GetWhatsAppNumberKycForm200ResponseFieldsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetWhatsAppNumberKycForm200ResponseFieldsInner struct {
	value *GetWhatsAppNumberKycForm200ResponseFieldsInner
	isSet bool
}

func (v NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) Get() *GetWhatsAppNumberKycForm200ResponseFieldsInner {
	return v.value
}

func (v *NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) Set(val *GetWhatsAppNumberKycForm200ResponseFieldsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWhatsAppNumberKycForm200ResponseFieldsInner(val *GetWhatsAppNumberKycForm200ResponseFieldsInner) *NullableGetWhatsAppNumberKycForm200ResponseFieldsInner {
	return &NullableGetWhatsAppNumberKycForm200ResponseFieldsInner{value: val, isSet: true}
}

func (v NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWhatsAppNumberKycForm200ResponseFieldsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
