...
// checks if the FollowUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FollowUser200Response{}

// FollowUser200Response struct for FollowUser200Response
...
// GetPendingFollow returns the PendingFollow field value if set, zero value otherwise.
func (o *FollowUser200Response) GetPendingFollow() bool {
	if o == nil || IsNil(o.PendingFollow) {
		var ret bool
		return ret
	}
	return *o.PendingFollow
}

// GetPendingFollowOk returns a tuple with the PendingFollow field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FollowUser200Response) GetPendingFollowOk() (*bool, bool) {
	if o == nil || IsNil(o.PendingFollow) {
		return nil, false
	}
	return o.PendingFollow, true
}
...
// SetPendingFollow gets a reference to the given bool and assigns it to the PendingFollow field.
...
func (o FollowUser200Response) MarshalJSON() ([]byte, error) {
...
func (o FollowUser200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PendingFollow) {
		toSerialize["pending_follow"] = o.PendingFollow
	}
	if !IsNil(o.Platform) {
...
type NullableFollowUser200Response struct {
	value *FollowUser200Response
	isSet bool
}

func (v NullableFollowUser200Response) Get() *FollowUser200Response {
	return v.value
}

func (v *NullableFollowUser200Response) Set(val *FollowUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFollowUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFollowUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFollowUser200Response(val *FollowUser200Response) *NullableFollowUser200Response {
	return &NullableFollowUser200Response{value: val, isSet: true}
}

func (v NullableFollowUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFollowUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
