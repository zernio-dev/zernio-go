...
func (o *UpdateWebhookSettingsRequest) GetAccountIds() []string {
...
// and a boolean to check if the value has been set.
func (o *UpdateWebhookSettingsRequest) GetAccountIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.AccountIds) {
		return nil, false
	}
...
func (o *UpdateWebhookSettingsRequest) HasAccountIds() bool {
	if o != nil && !IsNil(o.AccountIds) {
		return true
	}
...
func (o *UpdateWebhookSettingsRequest) SetAccountIds(v []string) {
	o.AccountIds = v
}
