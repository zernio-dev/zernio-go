...
func (a *PhoneNumbersAPIService) PurchasePhoneNumberExecute(r PhoneNumbersAPIPurchasePhoneNumberRequest) (*PurchasePhoneNumber200Response, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 503 {
			var v PurchasePhoneNumber503Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type PhoneNumbersAPIReplyToPhoneNumberReviewerRequest struct {
	ctx                               context.Context
	ApiService                        *PhoneNumbersAPIService
	id                                string
	replyToPhoneNumberReviewerRequest *ReplyToPhoneNumberReviewerRequest
}

func (r PhoneNumbersAPIReplyToPhoneNumberReviewerRequest) ReplyToPhoneNumberReviewerRequest(replyToPhoneNumberReviewerRequest ReplyToPhoneNumberReviewerRequest) PhoneNumbersAPIReplyToPhoneNumberReviewerRequest {
	r.replyToPhoneNumberReviewerRequest = &replyToPhoneNumberReviewerRequest
	return r
}

func (r PhoneNumbersAPIReplyToPhoneNumberReviewerRequest) Execute() (*ReplyToPhoneNumberReviewer200Response, *http.Response, error) {
	return r.ApiService.ReplyToPhoneNumberReviewerExecute(r)
}
...
least one attachment.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return PhoneNumbersAPIReplyToPhoneNumberReviewerRequest
*/
func (a *PhoneNumbersAPIService) ReplyToPhoneNumberReviewer(ctx context.Context, id string) PhoneNumbersAPIReplyToPhoneNumberReviewerRequest {
	return PhoneNumbersAPIReplyToPhoneNumberReviewerRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *PhoneNumbersAPIService) ReplyToPhoneNumberReviewerExecute(r PhoneNumbersAPIReplyToPhoneNumberReviewerRequest) (*ReplyToPhoneNumberReviewer200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ReplyToPhoneNumberReviewer200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PhoneNumbersAPIService.ReplyToPhoneNumberReviewer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/phone-numbers/{id}/remediate/reply"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.replyToPhoneNumberReviewerRequest == nil {
		return localVarReturnValue, nil, reportError("replyToPhoneNumberReviewerRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.replyToPhoneNumberReviewerRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type PhoneNumbersAPIRespondToPhoneNumberReviewerRequest struct {
	ctx                                 context.Context
	ApiService                          *PhoneNumbersAPIService
	id                                  string
	respondToPhoneNumberReviewerRequest *RespondToPhoneNumberReviewerRequest
}

func (r PhoneNumbersAPIRespondToPhoneNumberReviewerRequest) RespondToPhoneNumberReviewerRequest(respondToPhoneNumberReviewerRequest RespondToPhoneNumberReviewerRequest) PhoneNumbersAPIRespondToPhoneNumberReviewerRequest {
	r.respondToPhoneNumberReviewerRequest = &respondToPhoneNumberReviewerRequest
	return r
}

func (r PhoneNumbersAPIRespondToPhoneNumberReviewerRequest) Execute() (*RespondToPhoneNumberReviewer200Response, *http.Response, error) {
	return r.ApiService.RespondToPhoneNumberReviewerExecute(r)
}

/*
RespondToPhoneNumberReviewer Respond to the regulatory reviewer (message + corrections)
...
are loose files (their links are added to your message).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return PhoneNumbersAPIRespondToPhoneNumberReviewerRequest
*/
func (a *PhoneNumbersAPIService) RespondToPhoneNumberReviewer(ctx context.Context, id string) PhoneNumbersAPIRespondToPhoneNumberReviewerRequest {
	return PhoneNumbersAPIRespondToPhoneNumberReviewerRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *PhoneNumbersAPIService) RespondToPhoneNumberReviewerExecute(r PhoneNumbersAPIRespondToPhoneNumberReviewerRequest) (*RespondToPhoneNumberReviewer200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RespondToPhoneNumberReviewer200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PhoneNumbersAPIService.RespondToPhoneNumberReviewer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/phone-numbers/{id}/remediate/respond"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.respondToPhoneNumberReviewerRequest == nil {
		return localVarReturnValue, nil, reportError("respondToPhoneNumberReviewerRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.respondToPhoneNumberReviewerRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
