...
func (o *AttachCampaignAssetsRequest) GetAdAccountId() string {
...
// and a boolean to check if the value has been set.
func (o *AttachCampaignAssetsRequest) GetAdAccountIdOk() (*string, bool) {
	if o == nil || IsNil(o.AdAccountId) {
		return nil, false
	}
...
func (o *AttachCampaignAssetsRequest) HasAdAccountId() bool {
	if o != nil && !IsNil(o.AdAccountId) {
		return true
	}
...
func (o *AttachCampaignAssetsRequest) SetAdAccountId(v string) {
	o.AdAccountId = &v
}
