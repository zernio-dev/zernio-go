...
type AccountsAPIListTikTokCommercialMusicRequest struct {
	ctx         context.Context
	ApiService  *AccountsAPIService
	accountId   string
	countryCode *string
...
func (r AccountsAPIListTikTokCommercialMusicRequest) CountryCode(countryCode string) AccountsAPIListTikTokCommercialMusicRequest {
	r.countryCode = &countryCode
	return r
}

func (r AccountsAPIListTikTokCommercialMusicRequest) Execute() (*ListTikTokCommercialMusic200Response, *http.Response, error) {
	return r.ApiService.ListTikTokCommercialMusicExecute(r)
}
...
Returns the 100 currently trending tracks of TikTok's Commercial Music Library for a TikTok account connected through the TikTok for Business app. Use a track id as tiktokSettings.musicSoundInfo.musicSoundId when creating a post. The list is not paged; countryCode selects the country chart.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param accountId The TikTok account ID
	@return AccountsAPIListTikTokCommercialMusicRequest
*/
func (a *AccountsAPIService) ListTikTokCommercialMusic(ctx context.Context, accountId string) AccountsAPIListTikTokCommercialMusicRequest {
	return AccountsAPIListTikTokCommercialMusicRequest{
		ApiService: a,
		ctx:        ctx,
		accountId:  accountId,
...
func (a *AccountsAPIService) ListTikTokCommercialMusicExecute(r AccountsAPIListTikTokCommercialMusicRequest) (*ListTikTokCommercialMusic200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListTikTokCommercialMusic200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.ListTikTokCommercialMusic")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/accounts/{accountId}/tiktok/commercial-music"
	localVarPath = strings.Replace(localVarPath, "{"+"accountId"+"}", url.PathEscape(parameterValueToString(r.accountId, "accountId")), -1)
