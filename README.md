...
| `client.GetYouTubeVideoRetentionWithResponse()` | Get YouTube video retention curve |
...
| `client.ListAdCatalogProductSetsWithResponse()` | List a catalog's product sets |
| `client.ListAdCatalogsWithResponse()` | List Meta product catalogs |
...
| Method | Description |
|--------|-------------|
| `client.GetGmbAttributeMetadataWithResponse()` | Get attribute metadata |
...
| `client.CreateInboxConversationWithResponse()` | Create conversation (send a WhatsApp template) |
...
| Method | Description |
|--------|-------------|
| `client.SendSmsWithResponse()` | Send an SMS or MMS |
...
| `client.GetWhatsAppBlockStatusWithResponse()` | Check if a user is blocked |
...
| `client.ValidateWhatsAppNumberKycAddressWithResponse()` | Pre-validate a regulated-number KYC address (Tier 4) |
